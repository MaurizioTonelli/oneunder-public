...
import { QuickScoreCaptureModal } from "./QuickScoreCaptureModal";
...
export const ScoreRow = ({
  ...
  return (
    <Tr onClick={onOpen} _hover={{ opacity: 0.6, cursor: "pointer" }}>
      ...
      <QuickScoreCaptureModal isOpen={isOpen} onClose={onClose} score={score} />
    </Tr>
  );
};
