...
export default function Layout({
  ...
  const navigation = [
    ...
    {
      name: "Tournaments",
      href: "/app/admin/tournaments",
      icon: PlayIcon,
      current: pathname.split("/").includes("tournaments"),
    },
    {
      name: "Players",
      href: "#",
      icon: UsersIcon,
      current: pathname.split("/").includes("players"),
    },
    {
      name: "Rounds",
      href: "#",
      icon: PuzzlePieceIcon,
      current: pathname.split("/").includes("rounds"),
    },
  ];
  return (
    <div>
                            ...
                            <li key={team.name}>
                              <a
                                ...
                                className={classNames(
                                  team.current
                                    ? "bg-neutral-50 text-oneunder-600"
                                    : "text-neutral-700 hover:text-oneunder-600 hover:bg-neutral-50",
                              ...
                              >
                                <span
                                  className={classNames(
                                    team.current
                                      ? "text-oneunder-600 border-oneunder-600"
                                      : "text-neutral-400 border-neutral-200 group-hover:border-oneunder-600 group-hover:text-oneunder-600",
      ...
      <aside className="fixed inset-y-0 left-72 hidden w-96 overflow-y-auto border-r border-neutral-200 px-4 py-6 sm:px-6 lg:px-8 xl:block">
